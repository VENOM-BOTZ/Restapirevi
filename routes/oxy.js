...
async function photoOxy(req, res) {
    ...
    let listTema = ['/naruto', '/cslogo', '/cross', '/fps', '/graffiti', '/love', '/wood', '/coffee', '/stars', '/butterfly', '/summer', '/candy', '/royal', '/underwater',
   ...
   if (tema === 'cslogo') {
        url.push('https://photooxy.com/cs-go/great-cs-go-banner-131.html')
    if (tema === 'cross') {
        url.push('https://photooxy.com/cross-fire/nice-cross-fire-cover-137.html')
    if (tema === 'fps') {
        url.push('https://photooxy.com/fps-game-effect/make-avatar-challenges-warface-155.html')
    if (tema === 'graffiti') {
        url.push('https://photooxy.com/banner-cover/graffiti-text-cover-222.html')
    if (tema === 'metal') {
        url.push('https://photooxy.com/logo-and-text-effects/create-a-wolf-metal-text-effect-365.html')
    if (tema === 'shadow') {
